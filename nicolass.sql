...
-- Dumping data for table jobseeker.job_postings: ~5 rows (approximately)
INSERT INTO `job_postings` (`job_id`, `job_title`, `job_description`, `location`, `salary`, `image_path`, `last_updated`) VALUES
	(22, 'security manager', 'developing and implementing comprehensive security strategies', 'Taiwan', '$17800', '/uploads/images.jpg', '2024-12-10 11:50:30'),
	(23, 'mechanic', 'ensure that vehicles and machinery are functioning efficiently and safely', 'Korea', '$1100', '/uploads/images.jpg', '2024-12-10 11:49:45'),
	(24, 'fire fighter', 'provides prevention, rescue, and suppression services for fires', 'China', '$9000', '/uploads/images.jpg', '2024-12-10 11:50:21'),
	(25, 'surgeon', 'operate on patients to treat injuries, such as broken bones; diseases, such as cancerous tumors; and deformities, such as cleft palates', 'Indonesia', '$15000', '/uploads/ss.png', '2024-12-10 11:50:42'),
	(26, 'doctor', 'diagnosing and treating patients to promote their health and safety', 'Japan', '$8000', NULL, '2024-12-10 11:50:14');
